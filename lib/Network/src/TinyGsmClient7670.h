...
#ifndef SRC_TINYGSMCLIENTSIM7670_H_
#define SRC_TINYGSMCLIENTSIM7670_H_
...
class TinyGsmSim7670 : public TinyGsmModem<TinyGsmSim7670>,
                       public TinyGsmGPRS<TinyGsmSim7670>,
                       public TinyGsmTCP<TinyGsmSim7670, TINY_GSM_MUX_COUNT>,
                       public TinyGsmSMS<TinyGsmSim7670>,
                       public TinyGsmGSMLocation<TinyGsmSim7670>,
                       public TinyGsmGPS<TinyGsmSim7670>,
                       public TinyGsmTime<TinyGsmSim7670>,
                       public TinyGsmNTP<TinyGsmSim7670>,
                       public TinyGsmBattery<TinyGsmSim7670>,
                       public TinyGsmTemperature<TinyGsmSim7670>,
                       public TinyGsmCalling<TinyGsmSim7670> {
    friend class TinyGsmModem<TinyGsmSim7670>;
    friend class TinyGsmGPRS<TinyGsmSim7670>;
    friend class TinyGsmTCP<TinyGsmSim7670, TINY_GSM_MUX_COUNT>;
    friend class TinyGsmSMS<TinyGsmSim7670>;
    friend class TinyGsmGPS<TinyGsmSim7670>;
    friend class TinyGsmGSMLocation<TinyGsmSim7670>;
    friend class TinyGsmTime<TinyGsmSim7670>;
    friend class TinyGsmNTP<TinyGsmSim7670>;
    friend class TinyGsmBattery<TinyGsmSim7670>;
    friend class TinyGsmTemperature<TinyGsmSim7670>;
    friend class TinyGsmCalling<TinyGsmSim7670>;

    /*
     * Inner Client
     */
public:
    class GsmClientSim7670 : public GsmClient {
        friend class TinyGsmSim7670;

    public:
        GsmClientSim7670() {}

        explicit GsmClientSim7670(TinyGsmSim7670& modem, uint8_t mux = 0) {
            init(&modem, mux);
        }

        bool init(TinyGsmSim7670* modem, uint8_t mux = 0) {
            this->at       = modem;
            sock_available = 0;
            prev_check     = 0;
    ...
    /*TODO(?))
    class GsmClientSecureSIM7670 : public GsmClientSim7670
    {
    public:
      GsmClientSecure() {}
  
      GsmClientSecure(TinyGsmSim7670& modem, uint8_t mux = 0)
    ...
    */
     ...
     */
public:
    explicit TinyGsmSim7670(Stream& stream) : stream(stream) {
...
protected:
    bool initImpl(const char* pin = NULL) {
        ...
        DBG(GF("### TinyGSM Compiled Module:  TinyGsmClientSIM7670"));
...
protected:
    GsmClientSim7670* sockets[TINY_GSM_MUX_COUNT];
    const char*       gsmNL = GSM_NL;
};

#endif  // SRC_TINYGSMCLIENTSIM7670_H_
